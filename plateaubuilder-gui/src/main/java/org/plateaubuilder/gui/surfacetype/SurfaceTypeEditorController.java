package org.plateaubuilder.gui.surfacetype;
...
import org.plateaubuilder.core.editor.surfacetype.*;
import org.plateaubuilder.core.editor.Editor;
import org.plateaubuilder.gui.UIConstants;
import org.plateaubuilder.core.utils.ColorUtils;
...
public class SurfaceTypeEditorController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        SurfaceTypeEditor surfaceTypeEditor = Editor.getSurfaceTypeEditor();
    ...
    private void showComponentSelectUI() {
        ...
        if (Editor.getSurfaceTypeEditor().getComponentPolygonEditor().getSelectedSections().isEmpty()) {
            // チュートリアルテキストを表示
    ...
    private void showComponentOpeningSelectUI() {
        ...
        if (!Editor.getSurfaceTypeEditor().getComponentOpeningEditor().selectedTargetProperty().get()) {
            // チュートリアルテキストを表示
    ...
    private void refreshTypeList() {
        var editor = Editor.getSurfaceTypeEditor();
    ...
    public void onClickComponentPolygonEditButton() {
        Editor.getSurfaceTypeEditor().getComponentPolygonEditor().modeProperty().set(ComponentPolygonEditor.EditorMode.EDIT_POLYGONS);
    }

    public void onClickComponentPolygonCancelButton() {
        var editor = Editor.getSurfaceTypeEditor().getComponentPolygonEditor();
        editor.reset();
        Editor.getSurfaceTypeEditor().clear();
    }
    ...
    public void onClickComponentOpeningCancelButton() {
        var editor = Editor.getSurfaceTypeEditor().getComponentOpeningEditor();
        editor.reset();
        Editor.getSurfaceTypeEditor().clear();
    }
    ...
    public void onClickComponentOpeningEditButton() {
        Editor.getSurfaceTypeEditor().getComponentOpeningEditor().modeProperty().set(ComponentOpeningEditor.EditorMode.EDIT_OPENINGS);
    }
}
