package org.plateaubuilder.validation.constant;
...
public interface MessageError {
    ...
    String ERR_L07_002_1 = "L07: 地物\"{0}\":\n" +
            "次のgml:LineStringまたはgml:LinearRing座標の形式が不正です。\n{1}" +
            "近接閾値（0.01m）未満の頂点が連続するインスタンスが存在します：\n{2}";

    String ERR_L08_001 = "L08: 地物\"{0}\":";
    String ERR_L08_002 = "L08: 地物\"{0}\":\n" +
            "次のgml:LineStringの値が不正です。\n{1}";
    ...
    String ERR_L12_002_1 = "L12: 地物\"{0}\":\n" +
            "同一平面からの誤差が0.03m以上のインスタンスが存在します";
    ...
    String ERR_L14_002_5 = "<gml:Polygon gml:id=\"{0}\">境界面が立体を分断している。\n";
    String ERR_L14_002_6 = "<gml:Polygon gml:id=\"{0}\">境界面が交差している。";
