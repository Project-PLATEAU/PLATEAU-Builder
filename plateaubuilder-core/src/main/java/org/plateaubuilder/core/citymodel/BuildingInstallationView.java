...
public class BuildingInstallationView extends AbstractGeometryView<BuildingInstallation> implements IFeatureView {
    public BuildingInstallationView(BuildingInstallation gml) {
        super(gml);
    ...
    public String getFeatureType() {
        return "bldg:outerBuildingInstallation";
    }

    @Override
    public List<ADEComponent> getADEComponents() {
        return getGML().getGenericApplicationPropertyOfBuildingInstallation();
    }
