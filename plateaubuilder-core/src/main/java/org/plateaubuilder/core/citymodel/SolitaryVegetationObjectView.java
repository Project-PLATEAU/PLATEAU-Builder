...
public class SolitaryVegetationObjectView extends AbstractGeometryView<SolitaryVegetationObject> implements IFeatureView {
    ...
    public List<ADEComponent> getADEComponents() {
        return getGML().getGenericApplicationPropertyOfSolitaryVegetationObject();
    }
    ...
    public Object getAttribute(String[] attributePaths) {
        ...
        case "species":
            return gml.getSpecies();
        case "height":
            return gml.getHeight();
        case "trunkDiameter":
            return gml.getTrunkDiameter();
        case "crownDiameter":
            return gml.getCrownDiameter();
        case "creationDate":
    ...
    public void setAttribute(String[] attributePaths, Object value) {
        ...
        case "species":
            ...
            gml.setSpecies((Code) value);
            break;
        case "height":
            if (!(value instanceof Length)) {
                throw new IllegalArgumentException("Invalid value type: " + value.getClass().getName());
            }
            gml.setHeight((Length) value);
            break;
        case "trunkDiameter":
            if (!(value instanceof Length)) {
                throw new IllegalArgumentException("Invalid value type: " + value.getClass().getName());
            }
            gml.setTrunkDiameter((Length) value);
            break;
        case "crownDiameter":
            if (!(value instanceof Length)) {
                throw new IllegalArgumentException("Invalid value type: " + value.getClass().getName());
            }
            gml.setCrownDiameter((Length) value);
            break;
        case "creationDate":
    ...
    public boolean isSetAttribute(String[] attributePaths) {
        ...
        case "species":
            return gml.isSetSpecies();
        case "height":
            return gml.isSetHeight();
        case "trunkDiameter":
            return gml.isSetTrunkDiameter();
        case "crownDiameter":
            return gml.isSetCrownDiameter();
        case "creationDate":
