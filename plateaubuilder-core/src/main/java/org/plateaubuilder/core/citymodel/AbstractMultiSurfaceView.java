...
abstract public class AbstractMultiSurfaceView<T extends AbstractGML> extends ManagedGMLView<T> {
    ...
    public AbstractMultiSurfaceView(T gml) {
        super(gml);
    ...
    public void toggleLODView(int lod) {
        var meshViews = new AbstractMultiSurfaceMeshView[] { lod1MultiSurface, lod2MultiSurface, lod3MultiSurface };
        for (int i = 1; i <= 3; ++i) {
