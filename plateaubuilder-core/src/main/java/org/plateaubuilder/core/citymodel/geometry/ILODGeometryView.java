 ...
 */
public interface ILODGeometryView extends ILODView {
    /**
     * {@code AbstractGeometry}を取得します。
     * 
     * @return {@code AbstractGeometry}
     */
    public AbstractGeometry getGmlObject();

    /**
     * {@code GeometrySurfaceTypeView}を取得します。
     * 
     * @return {@code GeometrySurfaceTypeView}
     */
    public GeometrySurfaceTypeView getSurfaceTypeView();
