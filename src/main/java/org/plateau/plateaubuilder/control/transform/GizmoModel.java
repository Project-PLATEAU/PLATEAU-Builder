...
import org.plateau.plateaubuilder.io.mesh.importers.Importer3D;
...
public class GizmoModel extends Parent {
    ...
    public GizmoModel() {
        ...
        try{
            ...
            moveXGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_move.obj").toExternalForm());
            moveYGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_move.obj").toExternalForm());
            moveZGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_move.obj").toExternalForm());
            rotationXGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_rotate.obj").toExternalForm());
            rotationYGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_rotate.obj").toExternalForm());
            rotationZGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_rotate.obj").toExternalForm());
            scaleXGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_scale.obj").toExternalForm());
            scaleYGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_scale.obj").toExternalForm());
            scaleZGizmoView = Importer3D.load(PLATEAUBuilderApp.class.getResource("Locater_scale.obj").toExternalForm());
        ...
        AnimationTimer animationTimer = new AnimationTimer() {
            public void handle(long now) {
                if (manipulator != null) {
                    ...
                    var camera = localToScene(PLATEAUBuilderApp.getCamera().getCamera(), Point3D.ZERO);
    ...
    private void setVisibleGizmo() {
        ...
        PLATEAUBuilderApp.getFeatureSellection().outlineVisibleProperty().set(this.controlMode == ControlMode.SELECT);
    }
