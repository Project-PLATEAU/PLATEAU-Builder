...
public class CoordinateDialogController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboboxCoordinateCodes.valueProperty().addListener((
                ObservableValue<? extends CoordinateCodesEnum> observable,
                CoordinateCodesEnum oldValue, CoordinateCodesEnum newValue) -> {
